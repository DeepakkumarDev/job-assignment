...
def google_login(request):
    ...
    params = {
        ...
        "response_type": "code",
        "scope": "openid email profile https://www.googleapis.com/auth/drive https://www.googleapis.com/auth/drive.file https://www.googleapis.com/auth/drive.metadata.readonly",
        "redirect_uri": settings.SOCIAL_AUTH_GOOGLE_REDIRECT_URI,
        "access_type": "offline",  # Ensures you get a refresh token
        "prompt": "consent",  # Force user to consent every time
    }
